...
<html>
	...
	<link rel="stylesheet" href="/css/onos_font.css">
   ...
   <body>
	...
	<div id="menu_rx">
		...
		<div class="menu_rx_riga" >
			<div id="deletezone" class="voce-menu-R side-col1" onmousedown="delete_check_box_show1();">Elimina</div>
			<div class="icona-menu-R delete side-col2"><i class="icon-bin"></i></div>
		</div>
		
		<div class="menu_rx_riga" >
			<div id="submit" class="voce-menu-R side-col1" onmousedown="delete_dialog()" >Applica</div>
