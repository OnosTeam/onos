...
void setup()
{
  ...
  //onosmod
   ...
   //strcat(serial_number, sysCfg.friendlyname); // sysCfg.otaUr must be shorter than 100 byte see sysCfg.otaUrl[] in settings.h

   //copy first 13 bytes from friendlyname
   serial_number[0]=sysCfg.friendlyname[0][0];
   serial_number[1]=sysCfg.friendlyname[0][1];
   serial_number[2]=sysCfg.friendlyname[0][2];
   serial_number[3]=sysCfg.friendlyname[0][3];
   serial_number[4]=sysCfg.friendlyname[0][4];
   serial_number[5]=sysCfg.friendlyname[0][5];
   serial_number[6]=sysCfg.friendlyname[0][6];
   serial_number[7]=sysCfg.friendlyname[0][7];
   serial_number[8]=sysCfg.friendlyname[0][8];
   serial_number[9]=sysCfg.friendlyname[0][9];
   serial_number[10]=sysCfg.friendlyname[0][10];
   serial_number[11]=sysCfg.friendlyname[0][11];
   serial_number[12]=sysCfg.friendlyname[0][12];


   //copy the first 8 bytes from the serial numer to get the hardware type so to get Sonoff1P from Sonoff1P0001

   hardware_type[0]=serial_number[0];
   hardware_type[1]=serial_number[1];
   hardware_type[2]=serial_number[2];
   hardware_type[3]=serial_number[3];
   hardware_type[4]=serial_number[4];
   hardware_type[5]=serial_number[5];
   hardware_type[6]=serial_number[6];
   hardware_type[7]=serial_number[7];
   ...
   strcat(sysCfg.otaUrl, hardware_type); // sysCfg.otaUr must be shorter than 100 byte see sysCfg.otaUrl[] in settings.h
