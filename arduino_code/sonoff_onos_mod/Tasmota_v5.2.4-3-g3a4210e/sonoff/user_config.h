...
// -- MQTT - Domoticz -----------------------------
//#define USE_DOMOTICZ                             // Enable Domoticz (+7k code, +0.3k mem) - Disable by // onosmod  #define
...
#define USE_WEBSERVER                            // Enable web server and wifi manager (+62k code, +8k mem) - Disable by //
  ...
  #define WEB_PASSWORD         "onosBestHome9999"//  onosmod [WebPassword] Web server Admin mode Password for WEB_USERNAME (empty  Disable)
  #define FRIENDLY_NAME        "Sonoff1P0000"          //onosmod will became the serial number [FriendlyName] Friendlyname up to 32
