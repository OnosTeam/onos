...
// -- MQTT ----------------------------------------
#define MQTT_USE               0                 // [Mqtt] Select default MQTT use (0 = Off, 1 = On)  0 onosmod http
...
// -- MQTT - Telemetry ----------------------------
#define TELE_PERIOD            0               // [TelePeriod] Telemetry (0 = disable, 10 - 3600 seconds) onosmod
// -- MQTT - Domoticz -----------------------------
//#define USE_DOMOTICZ                             // Enable Domoticz (+7k code, +0.3k mem) - Disable by // onosmod  #define DOMOTICZ_IN_TOPIC      "domoticz/in"   // Domoticz Input Topic
...
#define USE_WEBSERVER                            // Enable web server and wifi manager (+62k code, +8k mem) - Disable by //
  ...
  #define WEB_PASSWORD         "onosBestHome9999"//  onosmod [WebPassword] Web server Admin mode Password for WEB_USERNAME (empty  #define FRIENDLY_NAME        "Sonoff"          // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
  #define FRIENDLY_NAME        "Sonoff"          //onosmod [FriendlyName] Friendlyname up to 32 characters used by webpages and
...
#define USE_DISCOVERY                            // Enable mDNS for the following services (+8k code, +0.3k mem) - Disable by //
  ...
  //#define MQTT_HOST_DISCOVERY                    // Find MQTT host server (overrides MQTT_HOST if found)  onosmod
...
//#define USE_I2C                                  // onosmod(//) I2C using library wire (+10k code, 0.2k mem) - Disable by //  #define USE_BH1750                             // Add I2C code for BH1750 sensor
...
//#define USE_IR_REMOTE                            // onosmod(//) Send IR remote commands using library IRremoteESP8266 and//  #define USE_IR_HVAC                            // Support for HVAC system using IR (+2k code)

//#define USE_WS2812                               //onosmod(//) WS2812 Led string using library NeoPixelBus (+8k code, +1k mem) -  #define USE_WS2812_CTYPE     1                 // WS2812 Color type (0 - RGB, 1 - GRB)
