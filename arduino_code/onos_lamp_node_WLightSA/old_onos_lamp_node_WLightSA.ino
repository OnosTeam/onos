...
void composeSyncMessage(){
  ...
  //[S_001sy3.05ProminiS0001L000T0000_#]  after L comes 3 bytes for lux value, after T comes 4 bytes for time of powered on lamp
...
*/
 ...
 // the onos cmd was found           [S_001dw06001_#]
    ...
    //[S_001sr04051_#] 
      ...
      digitalWrite(received_message_second_pin_used,1); //set pull up resistors
      delay(5);

      digitalWrite(received_message_first_pin_used,received_message_value); 
      time_from_turn_on=millis();
      while (digitalRead(received_message_second_pin_used)==0){
        delay(1);
